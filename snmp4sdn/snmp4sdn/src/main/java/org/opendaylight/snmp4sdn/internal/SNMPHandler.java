...
public class SNMPHandler{
    ...
    String vlanEgressPortsOID = "1.3.6.1.4.1.9.9.68.1.2.2.1.2";
    ...
    */
    ...
    private Map<Integer, String> readLLDPRemoteChassisIDEntries(SNMPv1CommunicationInterface comInterface){
        ...
        try{
            ...
            System.out.println("to retieve oid ");
            System.out.println(lldpRemoteChassisIdOID);
            ...
            for(int i = 0; i < tableVars.size(); i++){
                ...
                String snmpOIDstr = snmpOID.toString();
                Integer portNum = retrievePortNumFromChassisOID(snmpOIDstr);

                byte[] valueBytes = (byte[])value.getValue();
                String valueStr = HexString.toHexString(valueBytes);
                
                table.put(portNum, valueStr);
                //System.out.println("Retrieved OID:  ");
                //System.out.println(snmpOIDstr);
    ...
    public Map<Integer, String>  readLLDPAllRemoteChassisID(Long sw_macAddr){//return <portNumber, remoteChassisID>
        ...
        System.out.println("snmp connection created to: ");
            System.out.println(sw_ipAddr.toString());
        //2. now can set fwd table entry
    ...
    public String getLLDPChassis(Long sw_macAddr){//return a hex-string, e.g. 70 72 CF 2A 80 E9 (just a chassis id, not mac address!)
        ...
        try{
            ...
            System.out.println(HexString.toHexString(sw_macAddr));
            String switchIP = cmethUtil.getIpAddr(sw_macAddr);
            InetAddress sw_ipAddr = InetAddress.getByName(switchIP);
    ...
    public Map<Integer, String>  readLLDPLocalPortIDs(Long sw_macAddr){//return <portNumber, remoteChassisID>
        ...
        System.out.println("snmp connection created...swtich IP addr=");
        System.out.println(sw_ipAddr.toString());
    ...
    private Map<Integer, String> readLLDPLocalPortIDEntries(SNMPv1CommunicationInterface comInterface){
        ...
        try{
            ...
            System.out.println("to retieve oid ");
            System.out.println(lldpLocalPortIdOID);
            System.out.println("readLLDPLocalPortIDEntries");
            ...
            for(int i = 0; i < tableVars.size(); i++){
                ...
                String snmpOIDstr = snmpOID.toString();
                Integer portNum = retrievePortNumFromPortOID(snmpOIDstr);
    ...
    private int retrievePortNumFromPortOID(String oidstr){//input is eg. :iso.0.8802.1.1.2.1.3.7.1.3.52, return is eg. 52
        //e.g. oidstr as "iso.0.8802.1.1.2.1.4.1.1.5.0.49.1", then return "49"
    ...
    public Map<Integer, String>  readLLDPRemotePortIDs(Long sw_macAddr){//return <portNumber, remoteChassisID>
    ...
    private Map<Integer, String> readLLDPRemotePortIDEntries(SNMPv1CommunicationInterface comInterface){
    ...
    public VLANTable getVLANTable(Node node){//return: all VLANs on the switch, and also the ports of each VLAN
        ...
        try{
            ...
            System.out.println("In getVLANTable for OID ");
            ...
            for(int i = 0; i < tableVars.size(); i++){
                ...
                SNMPObjectIdentifier snmpOID = (SNMPObjectIdentifier)pair.getSNMPObjectAt(0);
                System.out.println("Number of table entries in i1: " + snmpOID.toString());

                SNMPOctetString value = (SNMPOctetString)pair.getSNMPObjectAt(1);

                System.out.println("Number of table entries in i2: " + tableVars.size());
 
                String snmpOIDstr = snmpOID.toString();
                String vlanIDstr = snmpOIDstr.substring(snmpOIDstr.lastIndexOf(".") + 1);
                System.out.println("OIDstr " + snmpOIDstr);
                System.out.println("vlanIDstr" + vlanIDstr);
