...
public class SNMPPhysicalPort implements Cloneable, Serializable {
    ...
    public SNMPPhysicalPort(Integer portNumber){//s4s: OF doen't have this function, we write it here for convinience assigning the values of the data such as port number
